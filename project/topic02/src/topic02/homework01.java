...
//		ma.calcSqrt();		 
		...
		//2-輸入五個數值，依數字大小，由大至小列印
		  ...
		  Sorting01_test(); srt01.bleSrt(5 , 10, 33, 20, 2);
		  //5 , 10, 33, 20, 2 //6,14,30,50,77
		  

		 //
		 /*
		 GenderPriceTest GP= new GenderPriceTest();
		 GP.CalcPrice();
		*/
...
//		GT.calcGrade(105);
		...
		//用for-loop跟while-loop顯示九九乘法表
		
//		NineByNine nn = new NineByNine();
//		nn.disp9By9();
